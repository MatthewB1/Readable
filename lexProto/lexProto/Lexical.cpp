...
void Lexical::checkIdentifierValidity(const std::vector<Token *> &vec) {}
...
LiteralToken *Lexical::createLiteralToken(const std::string str, int line_no,
                                          int char_pos) {
...
LiteralToken *Lexical::createStrLiteralToken(const std::string str, int line_no,
                                             int char_pos) {
